    ...
    <div class="containt">
        ...
        <form action="main.php" method="POST"> 
            ...
            <select name="province" class="b font" required >
                ...
                <option value="ريمة" id="rem">ريمة</option>
                <option value="تعز" id="taz">تعز</option>
                <option value="الحديدة" id="hod">الحديدة</option>
           </select>
           ...
           <input type="submit" value="تسجيل" id="submit" class="font" name="submit">
        </form>
        ...
        $city = $_POST['city'];
        $result=mysqli_query($mysqli,"INSERT into bloodinfo values('$name','$bDate','$lDate','$phone','$email','$typeblood','$province','$city')");
        if($result){
            echo "Success";
        }else{
            echo "Filde";
